...
extern PlyFile* ply_write(FILE*, int, const char* const*, int);
extern PlyFile *ply_open_for_writing(const char *, int, const char* const *, int, float *);
extern void ply_describe_element(PlyFile *, const char *, int, int, const PlyProperty *);
...
extern void ply_get_property(PlyFile *, char *, const PlyProperty *);
